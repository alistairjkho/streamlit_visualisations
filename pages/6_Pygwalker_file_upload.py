...
#     # We pass the DataFrame directly to avoid relying on external state
#     # When you need to publish your app to the public, you should set the debug parameter to False to prevent other users from writing to your chart configuration file.
#     return StreamlitRenderer(df, spec="./gw_config.json", debug=False)

# # Use the DataFrame for other components or operations if it's available
# if 'df' in st.session_state:
#     st.write(st.session_state.df.head())

#     # Create or get an instance of the renderer when needed
#     if 'renderer' not in st.session_state:
#         st.session_state.renderer = get_pyg_renderer(st.session_state.df)

#     # When the 'Click me!' button is pressed, render the exploration interface
#     if st.button('Click me!'):
#         st.session_state.renderer.render_explore()
